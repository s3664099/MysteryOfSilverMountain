...
public class CommandExecutor {
	...
	public ActionResult executeCommand(Game game,Player player,ParsedCommand command) {
		...
		} else if (command.checkClimb()) {
			logger.info("Climb");
			result = new Climb(game,player,command).executeClimb();
		} else if (command.checkUse()) {
			logger.info("Use");
			result = new Use(game,player,command).executeUse();
		} else if (command.checkOpen()) {
			logger.info("Open");
			result = new Open(game,player,command).executeOpen();
		...
		} else if (command.checkRemove()) {
			logger.info("Remove");
			result = new Remove(game,player,command).executeRemove();
