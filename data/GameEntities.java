...
public class GameEntities {
    ...
    public static final int FLAG_SAFE_CODE = 41;
    public static final int FLAG_RING_NUMBER = 42;
    ...
    public static final int FLAG_WINE_POISONED = 47;
    ...
    public static final int FLAG_WEARING_UNIFORM = 51;
    public static final int FLAG_WORD_LOCATION = 52;
    public static final int FLAG_ROPE_TIED = 53;
    ...
    public static final int FLAG_WIZARD_DEAD = 63;
	...
	public static final String GRARG = "grarg";
	public static final String GRARGS = "grarg";
 ...
 * 13 February 2026 - Changed flag names
 * 14 February 2026 - Changed flag names
 * 21 February 2026 - Changed flag names
 * 22 February 2026 - Changed flag 51 name
 * 24 February 2026 - Renamed flag 40 & 53
 * 7 March 2026 - Changed flag name for Ogban's safe
 * 14 March 2026 - Changed flag 37 name
 * 23 March 2026 - Fixed spelling error for uniform
 * 29 April 2026 - Updated flag name
 ...
 * 5 August 2026 - Added kitchens and grargs to multiples
 */